...
public class PermissionUtility {
    ...
    public static boolean verifyLocationPermissions(AppCompatActivity appCompatActivity, Boolean requestLocation) {
    ...
    public static boolean verifyCalenderPermissions(Activity appCompatActivity) {
