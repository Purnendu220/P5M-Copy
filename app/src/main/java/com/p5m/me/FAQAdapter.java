...
import com.p5m.me.adapters.viewholder.FAQViewHolder;
...
public class FAQAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FAQAdapter(Context context, AdapterCallbacks adapterCallbacks) {
    ...
    public void addAll(List<FAQ> models) {
        list.addAll(models);
        addLoader();
    }
...
//        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_frequently_asked_questions, parent, false);
