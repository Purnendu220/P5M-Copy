...
public class GymVisitListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//    private final GymListListenerHelper gymListListenerHelper;
    ...
    public GymVisitListAdapter(Context context,  int shownInScreen, boolean showLoader) {
...
//        gymListListenerHelper = new GymListListenerHelper(context, activity, AppConstants.AppNavigation.SHOWN_IN_SEARCH, adapterCallbacks);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_GYM_LIST) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_left_gym_visits, parent, false);
