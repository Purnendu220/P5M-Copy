...
public class MemberShipViewHolder_ViewBinding implements Unbinder {
  ...
  public MemberShipViewHolder_ViewBinding(MemberShipViewHolder target, View source) {
    ...
    target.txtPackageOffredClasses = Utils.findRequiredViewAsType(source, R.id.txtPackageOffredClasses, "field 'txtPackageOffredClasses'", TextView.class);
  ...
  public void unbind() {
    ...
    target.txtPackageOffredClasses = null;
