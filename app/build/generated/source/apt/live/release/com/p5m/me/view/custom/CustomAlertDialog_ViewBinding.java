...
public class CustomAlertDialog_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CustomAlertDialog_ViewBinding(CustomAlertDialog target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CustomAlertDialog_ViewBinding(CustomAlertDialog target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CustomAlertDialog target = this.target;
