...
public class ExplorePageTrainerListViewHolder_ViewBinding implements Unbinder {
  private ExplorePageTrainerListViewHolder target;

  @UiThread
  public ExplorePageTrainerListViewHolder_ViewBinding(ExplorePageTrainerListViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ExplorePageTrainerListViewHolder target = this.target;
