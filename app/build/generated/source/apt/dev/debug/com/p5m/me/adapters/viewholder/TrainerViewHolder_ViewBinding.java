...
public class TrainerViewHolder_ViewBinding implements Unbinder {
  ...
  @UiThread
  public TrainerViewHolder_ViewBinding(TrainerViewHolder target, View source) {
    this.target = target;

    target.imageViewClass = Utils.findRequiredViewAsType(source, R.id.imageViewClass, "field 'imageViewClass'", ImageView.class);
    target.trainerName = Utils.findRequiredViewAsType(source, R.id.name, "field 'trainerName'", TextView.class);
  ...
  @CallSuper
  public void unbind() {
    TrainerViewHolder target = this.target;
