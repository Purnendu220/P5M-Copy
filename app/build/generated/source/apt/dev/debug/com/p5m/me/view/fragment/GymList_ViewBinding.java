...
public class GymList_ViewBinding implements Unbinder {
  private GymList target;

  @UiThread
  public GymList_ViewBinding(GymList target, View source) {
    this.target = target;
