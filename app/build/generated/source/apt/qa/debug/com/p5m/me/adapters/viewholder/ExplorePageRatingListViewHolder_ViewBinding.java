...
public class ExplorePageRatingListViewHolder_ViewBinding implements Unbinder {
  private ExplorePageRatingListViewHolder target;

  @UiThread
  public ExplorePageRatingListViewHolder_ViewBinding(ExplorePageRatingListViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ExplorePageRatingListViewHolder target = this.target;
