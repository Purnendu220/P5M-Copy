...
public class ExplorePagePriceModelViewHolder_ViewBinding implements Unbinder {
  private ExplorePagePriceModelViewHolder target;

  @UiThread
  public ExplorePagePriceModelViewHolder_ViewBinding(ExplorePagePriceModelViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ExplorePagePriceModelViewHolder target = this.target;
