...
public class Trainers_ViewBinding implements Unbinder {
  private Trainers target;

  @UiThread
  public Trainers_ViewBinding(Trainers target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public Trainers_ViewBinding(Trainers target, View source) {
    this.target = target;
