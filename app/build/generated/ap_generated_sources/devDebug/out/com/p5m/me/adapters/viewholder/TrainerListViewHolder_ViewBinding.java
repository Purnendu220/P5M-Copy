...
public class TrainerListViewHolder_ViewBinding implements Unbinder {
  private TrainerListViewHolder target;

  @UiThread
  public TrainerListViewHolder_ViewBinding(TrainerListViewHolder target, View source) {
    this.target = target;
    ...
    target.buttonFav = Utils.findRequiredViewAsType(source, R.id.buttonFav, "field 'buttonFav'", ImageButton.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    TrainerListViewHolder target = this.target;
