...
public class ExplorePageWorkoutViewHolder_ViewBinding implements Unbinder {
  private ExplorePageWorkoutViewHolder target;

  @UiThread
  public ExplorePageWorkoutViewHolder_ViewBinding(ExplorePageWorkoutViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ExplorePageWorkoutViewHolder target = this.target;
