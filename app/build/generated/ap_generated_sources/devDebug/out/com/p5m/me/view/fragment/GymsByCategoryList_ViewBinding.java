...
public class GymsByCategoryList_ViewBinding implements Unbinder {
  private GymsByCategoryList target;

  @UiThread
  public GymsByCategoryList_ViewBinding(GymsByCategoryList target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    GymsByCategoryList target = this.target;
