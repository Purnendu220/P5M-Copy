...
public class PriceModelViewHolder_ViewBinding implements Unbinder {
  private PriceModelViewHolder target;

  @UiThread
  public PriceModelViewHolder_ViewBinding(PriceModelViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PriceModelViewHolder target = this.target;
