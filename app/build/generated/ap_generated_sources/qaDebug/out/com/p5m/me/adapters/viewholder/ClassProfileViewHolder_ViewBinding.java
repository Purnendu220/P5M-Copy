...
public class ClassProfileViewHolder_ViewBinding implements Unbinder {
  ...
  public ClassProfileViewHolder_ViewBinding(ClassProfileViewHolder target, View source) {
    ...
    target.textViewOnlineInfoTitle = Utils.findRequiredViewAsType(source, R.id.textViewOnlineInfoTitle, "field 'textViewOnlineInfoTitle'", TextView.class);
    ...
    target.textViewClassCredits = Utils.findRequiredViewAsType(source, R.id.textViewClassCredits, "field 'textViewClassCredits'", TextView.class);
    target.layoutClassCredits = Utils.findRequiredViewAsType(source, R.id.layoutClassCredits, "field 'layoutClassCredits'", RelativeLayout.class);
  ...
  public void unbind() {
    ...
    target.textViewOnlineInfoTitle = null;
    ...
    target.textViewClassCredits = null;
    target.layoutClassCredits = null;
