...
public class ClassViewHolder_ViewBinding implements Unbinder {
  ...
  public ClassViewHolder_ViewBinding(ClassViewHolder target, View source) {
    ...
    target.textViewCreditPrice = Utils.findRequiredViewAsType(source, R.id.textViewCreditPrice, "field 'textViewCreditPrice'", TextView.class);
  }
  ...
  public void unbind() {
    ...
    target.textViewCreditPrice = null;
  }
}
